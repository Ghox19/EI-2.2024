...
# Por cada mascota adicional, la felicidad aumenta en promedio 0.5178 unidades

# R-cuadrado de 0.1342 indica que solo el 13.42% de la variabilidad en la felicidad es explicada por el 
# número de mascotas

# El valor bajo de R cuadrado ajustado (12.15%) indica que las mascotas explican una pequeña porción de 
# la variabilidad en la felicidad

# El error estándar residual de 1.561 indica variabilidad considerable en las predicciones
# Esto fue observado tambien en el grafico de los histogramas

modelo_ambos <- lm(Felicidad ~ N_mascotas + N_amigos, muestra)
cat("\n\n")
cat("Modelo directo 'n de mascotas y n de amigos' --> 'felicidad'\n")
cat("--------------------------------------------\n")
print(summary(modelo_ambos))